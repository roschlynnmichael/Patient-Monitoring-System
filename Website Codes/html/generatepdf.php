        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-auto bg-light sticky-top">
                    <div class="d-flex flex-sm-column flex-row flex-nowrap bg-light align-items-center sticky-top">
                        ...
                        <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center">
                            ...
                            <li>
                                <a href="generatepdf.php" class="nav-link py-3 px-2 active" aria_current="page" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Generate PDF">
                ...
                <div class="col-sm p-3 min-vh-100">
                    <h3 class="mb-2">Generate PDF format of the patient data available</h3>
                    </br>
                    ...
                    <div class="col-md-6 mb-4">
                        <form action="fpdfgenerate.php" method="post" autocomplete="off">
                            <input type="text" name="patient_id" id="patient_id" class="form-control form-control-lg">
                            <label class="form-label" for="patient_id">Enter Patient ID to generate the PDF</label>    
                            <div class="mt-4 pt-2">
